...
/*   Updated: 2023/09/19 18:30:48 by aguilmea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Test(tuples, normalize)
{
	...
	t_tuple normv1 = normalize(&v1);

	cr_assert(are_equal_tuples(&normv1, &v2), "The tuples are not equal");

	t_tuple v3 = vector(1, 2, 3);
	t_tuple v4 = vector(0.26726, 0.53452, 0.80178);
	t_tuple	normv3 = normalize(&v3);
	
	cr_assert(are_equal_tuples(&normv3, &v4), "The tuples are not equal");
